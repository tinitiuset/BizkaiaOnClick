...
<div class="row">
    ...
    <div class="col-9 p-0">
        {{-- {{$old}} --}}
            <form class="form-inline" action="{{ route('user.index') }}" method="GET" role="search">
              <input class="form-control mr-sm-2 w-50" name="buscar" type="search" placeholder="Buscar usuario" aria-label="Search" value="{{ old('buscar') }}">
              {{ old('buscar') }}
