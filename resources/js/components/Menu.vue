      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
        ...
        <div>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-3" v-else>
            ...
            <li class="nav-item" v-if="tipo == 'administrador'">
              <a class="nav-link text-white text-center texto-degradado" title="Panel de administracion"  href="/admin"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-journal iconoMenu" viewBox="0 0 16 16">
            ...
            <li class="nav-item" v-if="tipo == 'usuario' ">
              <a class="nav-link text-white texto-degradado text-center" title="Editar perfil" href="/usuario"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-person-circle iconoMenu" viewBox="0 0 16 16">
