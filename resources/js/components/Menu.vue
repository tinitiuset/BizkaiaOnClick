        ...
        <div>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-3" v-else>
            ...
            <li class="nav-item" v-if="tipo == 'usuario' ">
              <a class="nav-link text-white texto-degradado text-center" title="Editar perfil" href="/perfil"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-person-circle iconoMenu" viewBox="0 0 16 16">
